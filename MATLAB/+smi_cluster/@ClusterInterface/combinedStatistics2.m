...
SC.plotCombined(clust_width, ...
                1, 'cluster widths (nm)', ...
                econd, 'clust_width', colors, line_type);
...
SC.plotCombined(clust_width_ROI, ...
                ...
                econd, 'clust_width_ROI', colors, line_type);
...
SC.plotCombined(compactness, ...
                0.05, 'cluster compactness (4\pi A)/P^2)', econd, ...
...
SC.plotCombined(compactness_ROI, ...
                0.05, 'cluster compactness (4\pi A/P^2) per ROI', econd, ...
...
SC.plotCombined(circularity, ...
                ...
                econd, 'circularity', colors, line_type);
...
SC.plotCombined(circularity_ROI, ...
                ...
                econd, 'circularity_ROI', colors, line_type);
...
SC.plotCombined(convexity, ...
                0.05, 'cluster convexity (Pconvex/Pcompact)', econd, ...
                'convexity', colors, line_type);
...
SC.plotCombined(convexity_ROI, ...
                ...
                econd, 'convexity_ROI', colors, line_type);
...
SC.plotCombined(solidity, ...
                0.05, 'cluster solidity (Acompact/Aconvex)', econd, ...
                'solidity', colors, line_type);
...
SC.plotCombined(solidity_ROI, ...
                ...
                econd, 'solidity_ROI', colors, line_type);
...
SC.plotCombined(n_pts_per_clust_per_area, 1,             ...
                ...
                'npts_per_clust_per_area', colors, line_type);
...
SC.plotCombined(n_pts_per_clust_per_area_ROI, 1,                 ...
                ...
                'npts_per_clust_per_area_ROI', colors, line_type);
