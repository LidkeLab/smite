    ...
    for ss = 1:NSubFields
        ...
        if ismember(CurrentSubfieldName, SpecialFields)
            ...
            elseif strcmp(CurrentSubfieldName, 'Data.DatasetMods')
                ...
                UIControls{ff}{ss}{1} = uicontrol(PropertyTabs{ff}, ...
                    'Style', 'popupmenu', ...
                    'String', {'Include Datasets', 'Exclude Datasets'}, ...
                    'Tooltip', CurrentFieldNote.Tip, ...
                    'Units', 'normalized', ...
                    'Position', UIControlInitPos ...
                    + [0, CurrentYPosition, 0, 0], ...
                ...
                UIControls{ff}{ss}{2} = uicontrol(PropertyTabs{ff}, ...
                    ...
                    'Callback', @guiToProperties);
            elseif strcmp(CurrentSubfieldName, 'Data.CalibrationFilePath')
            ...
            for mm = 1:numel(PropertyFields)
                ...
                if ismember(CurrentFieldName, SpecialFields)
                    ...
                    elseif strcmp(CurrentFieldName, 'Data.DatasetMods')
                        ...
                        % display Data.DatasetMods{2}).
                        NewString = sprintf('%i,', ...
                            CurrentField{UIControls{nn}{mm}{1}.Value});
                        UIControls{nn}{mm}{2}.String = NewString(1:end-1);
                    elseif strcmp(CurrentFieldName, ...
                            'Data.CalibrationFilePath')
                        % Data.CalibrationFilePath should be displayed in
                        % the edit box (i.e., UIControls{nn}{mm}{1}).
                        UIControls{nn}{mm}{1}.String = CurrentField;
                    ...
                    elseif strcmp(CurrentFieldName, 'Fitting.ZFitStruct')
                        ...
                        % a pop-up menu.
                        UIControls{nn}{mm}{2}.String = num2str(...
                            CurrentField.(UIControls{nn}{mm}{1}.String{...
                ...
                if ismember(CurrentPropertyName, SpecialFields)
                    if strcmp(CurrentPropertyName, 'Data.FileName')
                        ...
                        obj.(PropertyNames{nn}).(PropertyFields{mm}) = ...
                            UIControls{nn}{mm}{1}.String;
                    elseif strcmp(CurrentPropertyName, 'Data.DatasetMods')
                        % Data.DatasetMods is a cell array, and we want to
                        % update the element specified by a pop-up menu.
                        CellIndex = UIControls{nn}{mm}{1}.Value;
                        CurrentPropertyValue = obj.(PropertyNames{nn}) ...
                            .(PropertyFields{mm}){CellIndex};
                        obj.(PropertyNames{nn}).(PropertyFields{mm}) ...
                            {CellIndex} = processUserInput(...
                            UIControls{nn}{mm}{2}, CurrentPropertyValue);
                    elseif strcmp(CurrentPropertyName, ...
                            'Data.CalibrationFilePath')
                        % Data.CalibrationFilePath can be updated directly
                        % with the string stored in UIControls{nn}{mm}{1}.
                        obj.(PropertyNames{nn}).(PropertyFields{mm}) = ...
                            UIControls{nn}{mm}{1}.String;
