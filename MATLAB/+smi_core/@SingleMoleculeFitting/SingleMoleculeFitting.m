classdef SingleMoleculeFitting < matlab.mixin.Copyable
    ...
    %   NIterationsMax: Max. number of iterative tracking attempts (Integer)(Default = 10)
    ...
    methods
        ...
        function obj = SingleMoleculeFitting()
            ...
            obj.Tracking.NIterationsMax=10;
            ...
            obj.SMFFieldNotes.Tracking.MinTrackLength.Units = ...
                'observations';
            obj.SMFFieldNotes.Tracking.NIterationsMax.Units = '';
            ...
            obj.SMFFieldNotes.Tracking.TrajwiseD.Tip = ...
                ...
                'iteratively tracking.  ''NIterationsMax'' must be\n', ...
            ...
            obj.SMFFieldNotes.Tracking.NIterationsMax.Tip = ...
        ...
        function set.Tracking(obj, TrackingInput)
            ...
            if isfield(TrackingInput, 'NIterationsMax')
                if mod(TrackingInput.NIterationsMax, 1)
                    error(['''SMF.Tracking.NIterationsMax'' ', ...
                        'must be an integer.'])
                end
            end
