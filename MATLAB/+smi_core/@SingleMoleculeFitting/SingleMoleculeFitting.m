classdef SingleMoleculeFitting < matlab.mixin.Copyable
    ...
    %   NRecursions:    Number of recursive FC attempts when Method=lap-fc (Default=1)
    %
    ...
    methods
        ...
        function obj = SingleMoleculeFitting()
            ...
            obj.FrameConnection.NRecursions=1;
            ...
            obj.SMFFieldNotes.Data.DataROI.Units = ...
                'pixels, [YStart, XStart, YEnd, XEnd, ZPeriod]';
            ...
            obj.SMFFieldNotes.FrameConnection.NNearestClusters.Units = ...
                'positive integer';
            obj.SMFFieldNotes.FrameConnection.NRecursions.Units = ...
                'positive integer';
            ...
            obj.SMFFieldNotes.FrameConnection.NRecursions.Tip = ...
                sprintf(['Number of recursive calls to the LAP-FC\n', ...
                'algorithm when Method=''LAP-FC''.  With each\n', ...
                'recursion, internal parameters are re-estimated\n', ...
                'from the previous recursion''s results.']);
        ...
        function set.FrameConnection(obj, FCInput)
            ...
            if isfield(FCInput, 'NRecursions')
                if (mod(FCInput.NRecursions, 1) || (FCInput.NRecursions<1))
                    error(['''SMF.FrameConnection.NRecursions'' ', ...
                        'must be a positive integer.'])
                end
            end
