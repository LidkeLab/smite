...
uicontrol(FilePanel, 'Style', 'text', ...
...
uicontrol(FilePanel, 'Style', 'text', ...
    ...
    'Units', 'normalized', ...
    'Position', ...
    TextSize + [0, 1-2*ButtonSize(4)-PopupSize(4)-2*TextSize(4), 0, 0]);
ControlHandles.AutoscaleFiducialCheckbox = uicontrol(FilePanel, ...
    'Style', 'checkbox', 'Value', obj.AutoscaleFiducials, ...
    'Units', 'normalized', ...
    'Position', CheckSize + [TextSize(3), ...
    1-2*ButtonSize(4)-PopupSize(4)-2*TextSize(4), 0, 0], ...
    'Tooltip', AutoscaleTooltip, ...
    'Callback', @refresh);
...
ControlHandles.VisualizeTransformButton = uicontrol(...
    ...
    'Style', 'pushbutton', ...
    'FontUnits', 'normalized', 'FontSize', 0.5, 'FontWeight', 'bold', ...
    'String', 'Visualize transform', ...
    'Units', 'normalized', ...
    'Position', ButtonSize+[0, 1-2*ButtonSize(4), 0, 0], ...
    'Tooltip', 'Visualize the transform (opens a new figure).', ...
    'Callback', @visualizeTransform);
...
%}
    ...
    function addFile(~, ~)
        ...
        ControlHandles.FileList.String = FileName;
        
        % Update the reference file display.
        ControlHandles.ReferenceFileName.String = ...
            ControlHandles.FileList.String{ControlHandles.FileList.Value};
    ...
    function selectReference(Source, ~)
        ...
        % Reorder the files so that the currently selected file is at the
        % top of the list (and do the same in obj.SMF.Data.FileName).
    ...
    function visualizeTransform(~, ~)
        ...
        for ii = 2:numel(obj.RegistrationTransform)
            ...
            if strcmp(obj.TransformationBasis, 'coordinates')
                obj.visualizeCoordTransform(...
                    figure('Name', sprintf('Transform %i to 1', ii)), ...
