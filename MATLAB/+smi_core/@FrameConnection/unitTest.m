...
Success(3) = (BaseSuccess ...
    && (round(sum(double(SMDCombined.PSFSigma)), 4)==9.2274) ...
    && all(round(double(SMDCombined.PSFSigma_SE), 4)==0.0042));
...
Success(4) = (BaseSuccess ...
    && (round(sum(double(SMDCombined.PSFSigmaX)), 4)==8.5437) ...
    && (round(sum(double(SMDCombined.PSFSigmaY)), 4)==9.5851) ...
    && all(round(double(SMDCombined.PSFSigmaX_SE), 4)==0.0042) ...
    && all(round(double(SMDCombined.PSFSigmaY_SE), 4)==0.0042));
...
Success(5) = (BaseSuccess ...
    && all(round(double(SMDCombined.Z), 2)==ExpectedZ) ...
    && all(round(double(SMDCombined.Z_SE), 2)==ExpectedXYZ_SE));
