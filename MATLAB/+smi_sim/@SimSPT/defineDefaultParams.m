...
%                                 (1/frame)(Default = 1)
%                FrameSize: Size of the (square) frame within which the
...
%                                (Default = false)
%                KOff: Rate parameter for the disconnection of oligomers. 
%                      (1 / frame)(Default = 0.1)
%                KBleach: Rate parameter defining photobleaching.
%                         (1 / frame)(Default = 0.1)
%                KBlinkOff: Rate parameter defining the turning off of 
%                           visible emitters. (1 / frame)(Default = 0.5)
%                KBlinkOn: Rate parameter defining the turning on of 
...
ParamStruct.KOff = 0.1;
ParamStruct.KBleach = 0.1;
ParamStruct.KBlinkOff = 0.5;
ParamStruct.KBlinkOn = 0.5;
