...
- [smi_core.FRC.unitTest](../+smi_core/@FRC/unitTest.m) [DIPimage needed]
...
- [smi_psf.PointSpreadFunction.unitTest](../+smi_psf/@PointSpreadFunction/unitTest) (does the following unit tests)
  ...
  - [smi_psf.PointSpreadFunction.oversamplePSFPupil_unitTest](../+smi_psf/@PointSpreadFunction/oversamplePSFPupil_unitTest.m) [DIPimage needed]
  - [smi_psf.PointSpreadFunction.phaseRetrieval_unitTest](../+smi_psf/@PointSpreadFunction/phaseRetrieval_unitTest.m) [DIPimage needed]
